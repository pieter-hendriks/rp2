# Implementation of an NTP server in python
...
def handleExit(recv, work, socket):
	...
	while True:
		try:
			...
			if rc[:len(EXITSTRING)] == EXITSTRING:
				...
				handleExit(recvThread, workThread, mysocket)
				print("NTP handleExit method completed")
